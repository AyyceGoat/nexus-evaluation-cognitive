...
export default tseslint.config(
  ...
  },
  {
    ...
    files: [
      'scripts/verifie-rendu.mjs',
      'scripts/verifie-auth-differee.mjs',
      'scripts/mesure-fps.mjs',
      'scripts/verifie-mobile.mjs',
      'scripts/parcours-complet.mjs',
      'scripts/mesure-navigation.mjs',
    ],
    languageOptions: {
