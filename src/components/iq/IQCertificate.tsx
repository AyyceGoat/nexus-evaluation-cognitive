  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <article className="relative p-8 sm:p-12 rounded-2 bg-graphite border border-ardoise/60 text-center">
        ...
        <p className="text-[11px] uppercase tracking-[0.2em] text-brume mb-3">NEXUS</p>

        <h2 className="font-titre text-2xl sm:text-3xl font-bold text-craie mb-8">
          Attestation de passation
        </h2>

        <p className="text-xs sm:text-sm text-brume mb-2">Délivrée à</p>
        ...
        <p className="text-xs sm:text-sm text-brume max-w-lg mx-auto leading-relaxed mb-8">
        ...
        <dl className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-xl mx-auto mb-8 text-left">
          <div className="p-3 rounded-1 bg-ardoise/50 border border-ardoise text-center">
            <dt className="text-[10px] uppercase text-brume">Indice estimé</dt>
            <dd className="font-titre text-xl font-bold text-craie tabular-nums">
              {report.scaled.point}
            </dd>
          </div>
          <div className="p-3 rounded-1 bg-ardoise/50 border border-ardoise text-center">
            <dt className="text-[10px] uppercase text-brume">Intervalle 95 %</dt>
            <dd className="font-titre text-xl font-bold text-craie tabular-nums">
              {report.scaled.lower95}–{report.scaled.upper95}
            </dd>
          </div>
          <div className="p-3 rounded-1 bg-ardoise/50 border border-ardoise text-center">
            <dt className="text-[10px] uppercase text-brume">Centile</dt>
            <dd className="font-titre text-xl font-bold text-craie tabular-nums">
              {report.percentile !== null ? `${report.percentile}ᵉ` : '—'}
            </dd>
          </div>
          <div className="p-3 rounded-1 bg-ardoise/50 border border-ardoise text-center">
            <dt className="text-[10px] uppercase text-brume">Réussites</dt>
            <dd className="font-titre text-xl font-bold text-craie tabular-nums">
        ...
        <div className="pt-6 border-t border-ardoise/40 text-[11px] text-brume leading-relaxed max-w-lg mx-auto space-y-2">
          <p>
